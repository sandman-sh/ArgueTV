...
async def run_test():
    ...
    try:
        ...
        # -> Clear the topic input (index 7), submit the start debate action (press Enter), then wait for UI feedback so we can verify a topic validation error and that no debate content appears.
