...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Debate' button for the first news story to start a guest debate (element index 210).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[2]/div/div[3]/div[3]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the combined 'Download debate audio' button (index 3821) to initiate the MP3 download and finish the test.
        frame = context.pages[-1]
        # Click element
